  ...
  return (
    <View className="flex-1 relative bg-white">
      ...
      <SafeAreaView className={ios ? "-mb-8" : ""}>
        <View className="mx-4 flex-row justify-between items-center mt-5">
          <Image
      ...
      {/* coffee cards */}
      <View className="overflow-visible flex justify-center flex-1 items-center">
        <View className="mt-16">
          <Carousel
            containerCustomStyle={{ overflow: "visible" }}
            data={coffeeItems}
            renderItem={({ item }) => <CoffeeCards item={item} />}
            firstItem={1}
            loop={true}
